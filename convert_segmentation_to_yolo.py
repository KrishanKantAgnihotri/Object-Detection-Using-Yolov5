...
"""
Convert IDD20K segmentation masks (label.png) to YOLO object detection labels.
...
# Only use classes you want to detect (e.g., skip background, ignore classes)
...
def process_split(split):
    ...
    img_root = os.path.join("idd20k_lite", "leftImg8bit", split)
    ...
    for subfolder in os.listdir(mask_root):
        ...
        for mask_file in os.listdir(mask_dir):
            ...
            if os.path.exists(img_path):
                convert_mask_to_yolo(mask_path, img_path, label_path)
